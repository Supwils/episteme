...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const thinkerEntries: MetadataRoute.Sitemap = getThinkerSlugs().map(
    (slug) => ({
  ...
  const schoolEntries: MetadataRoute.Sitemap = getSchoolSlugs().map(
    (slug) => ({
  ...
  const experimentEntries: MetadataRoute.Sitemap = getExperimentSlugs().map(
    (slug) => ({
  ...
  const questionEntries: MetadataRoute.Sitemap = getQuestionSlugs().map(
    (slug) => ({
  ...
  const mathematicianEntries: MetadataRoute.Sitemap = getMathematicianSlugs().map(
    (slug) => ({
  ...
  const theoremEntries: MetadataRoute.Sitemap = getTheoremSlugs().map(
    (slug) => ({
  ...
  const mathConceptEntries: MetadataRoute.Sitemap = getMathConceptSlugs().map(
    (slug) => ({
  ...
  const mathDialogueEntries: MetadataRoute.Sitemap = getMathDialogueSlugs().map(
    (slug) => ({
  ...
  const economistEntries: MetadataRoute.Sitemap = getEconomistSlugs().map(
    (slug) => ({
  ...
  const econTheoryEntries: MetadataRoute.Sitemap = getEconTheorySlugs().map(
    (slug) => ({
  ...
  const econConceptEntries: MetadataRoute.Sitemap = getEconConceptSlugs().map(
    (slug) => ({
  ...
  const econSchoolEntries: MetadataRoute.Sitemap = getEconSchoolSlugs().map(
    (slug) => ({
  ...
  const econDebateEntries: MetadataRoute.Sitemap = getEconDebateSlugs().map(
    (slug) => ({
  ...
  const econDialogueEntries: MetadataRoute.Sitemap = getEconDialogueSlugs().map(
    (slug) => ({
  ...
  const theoristEntries: MetadataRoute.Sitemap = getTheoristSlugs().map(
    (slug) => ({
  ...
  const psyExperimentEntries: MetadataRoute.Sitemap = getPsyExperimentSlugs().map(
    (slug) => ({
  ...
  const phenomenonEntries: MetadataRoute.Sitemap = getPhenomenonSlugs().map(
    (slug) => ({
  ...
  const psySchoolEntries: MetadataRoute.Sitemap = getPsySchoolSlugs().map(
    (slug) => ({
  ...
  const disorderEntries: MetadataRoute.Sitemap = getDisorderSlugs().map(
    (slug) => ({
  ...
  const psyDebateEntries: MetadataRoute.Sitemap = getPsyDebateSlugs().map(
    (slug) => ({
  ...
  const psyDialogueEntries: MetadataRoute.Sitemap = getPsyDialogueSlugs().map(
    (slug) => ({
