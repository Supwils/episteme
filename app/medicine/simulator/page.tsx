    ...
    <main className="mx-auto w-full max-w-3xl px-5 py-16 sm:px-8">
      <header className="mb-8">
        ...
        <p className="text-fg-secondary max-w-2xl text-[15px] leading-relaxed">
          ...
          一百年前就写下的数学——
          <span className="text-fg-primary">SIR 模型</span>
      ...
      <section className="text-fg-secondary mt-10 space-y-4 text-[14.5px] leading-relaxed">
        ...
        <ul className="ml-5 list-disc space-y-2">
          <li>
            <strong className="text-fg-primary">「压平曲线」不是玄学。</strong>
            降低 R₀（戴口罩、保持距离）会把红色的峰压低、推后——峰值越低，医院越不容易被挤垮。
          </li>
          <li>
            <strong className="text-fg-primary">群体免疫有一道明确的阈值。</strong>
            当免疫人口超过 <code className="text-fg-secondary">1 − 1/R₀</code>，有效传染数 Rₑ 就跌破
            1，疫情自行消退。 R₀ 越大（如麻疹
            ~15），需要的接种率就越高（~95%）——这正是麻疹疫苗不能松懈的原因。
          </li>
          <li>
            <strong className="text-fg-primary">提高接种率，亲眼看峰塌下去。</strong>
        ...
        <div className="flex flex-wrap gap-4 pt-2 text-[13.5px]">
          <Link href="/medicine/concepts/epidemiology" className="text-accent-gold hover:underline">
            延伸阅读：流行病学 →
          </Link>
          <Link href="/medicine/concepts/vaccination" className="text-accent-gold hover:underline">
            疫苗原理 →
          </Link>
          <Link
