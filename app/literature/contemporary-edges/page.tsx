...
const sc = getSectionConfig("literature", "contemporary-edges");
const dc = getDomainConfig("literature");
...
export default function Page() {
  return <DomainSectionList domain="literature" section="contemporary-edges" />;
}
