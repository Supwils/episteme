  ...
  return (
    <div className="w-full px-6 py-12 sm:px-10 sm:py-16 lg:px-16">
      ...
      <section className="mb-20">
        <h2 className="text-fg-primary mb-6 text-lg font-semibold">交互式演化时间线</h2>
        <EvolutionTimeline events={TIMELINE_EVENTS} />
      </section>

      {/* Detailed vertical timeline */}
      <div className="relative">
        <div className="bg-border-faint absolute top-0 bottom-0 left-4 w-px sm:left-1/2" />
              ...
              >
                <div className={`flex-1 ${i % 2 === 0 ? "sm:pr-12 sm:text-right" : "sm:pl-12"}`}>
                  <Link
                    ...
                    className="group border-border-faint bg-bg-near hover:bg-bg-elevated block border p-5 transition-all duration-300 hover:shadow-[0_0_30px_-10px_rgba(74,158,111,0.1)]"
                  >
                    <div
                      className="mb-2 flex items-center gap-3 sm:justify-end"
                    ...
                    <h3 className="font-display text-fg-primary group-hover:text-accent-green mb-1 text-lg leading-snug font-semibold transition-colors">
                      {item.event}
                    </h3>
                ...
                <div className="absolute top-5 left-4 z-10 -translate-x-1/2 sm:left-1/2">
                  <div
