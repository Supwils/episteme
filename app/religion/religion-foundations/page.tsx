...
const sc = getSectionConfig("religion", "religion-foundations");
const dc = getDomainConfig("religion");
...
export default function Page() {
  return <DomainSectionList domain="religion" section="religion-foundations" />;
}
