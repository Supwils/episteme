...
const DOMAIN_CARDS = [
  { key: 'physics' as const, icon: '🔬', label: '宇宙物理', color: '#60a5fa', bg: 'rgba(59,130,246,0.1)', border: 'rgba(59,130,246,0.2)' },
  { key: 'history' as const, icon: '📜', label: '人类历史', color: '#f59e0b', bg: 'rgba(245,158,11,0.1)', border: 'rgba(245,158,11,0.2)' },
  { key: 'philosophy' as const, icon: '💭', label: '哲学思想', color: '#eab308', bg: 'rgba(234,179,8,0.1)', border: 'rgba(234,179,8,0.2)' },
  { key: 'economics' as const, icon: '📊', label: '经济学', color: '#10b981', bg: 'rgba(16,185,129,0.1)', border: 'rgba(16,185,129,0.2)' },
  { key: 'psychology' as const, icon: '🧠', label: '心理学', color: '#f472b6', bg: 'rgba(244,114,182,0.1)', border: 'rgba(244,114,182,0.2)' },
  { key: 'mathematics' as const, icon: '📐', label: '数学', color: '#a78bfa', bg: 'rgba(167,139,250,0.1)', border: 'rgba(167,139,250,0.2)' },
  { key: 'lifeScience' as const, icon: '🧬', label: '生命科学', color: '#22c55e', bg: 'rgba(34,197,94,0.1)', border: 'rgba(34,197,94,0.2)' },
  { key: 'cosmology' as const, icon: '🌌', label: '宇宙学', color: '#818cf8', bg: 'rgba(129,140,248,0.1)', border: 'rgba(129,140,248,0.2)' },
] as const;
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="flex-1 px-4 py-3 rounded-xl font-medium text-sm transition-all duration-200 cursor-pointer"
            style={{
