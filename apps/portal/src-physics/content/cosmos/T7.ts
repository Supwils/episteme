...
const content: TierContent = {
  ...
  dataCards: [
    ...
    {
      label: "旅行者 1 号拍摄距离",
      latinLabel: "Pale Blue Dot distance",
      value: "6.06 × 10⁹ km",
      hint: "≈ 40.5 AU · 1990-02-14",
    },
    {
      label: "已知物种总数",
      latinLabel: "Known species",
      value: "≈ 870 万",
      hint: "Mora et al. 2011 估算",
    },
  ],
  narrative: [
    {
    ...
    {
      heading: "Sagan 的沉思 · 暗淡蓝点的哲学",
      body: [
        "1990 年 2 月 14 日，在 Carl Sagan 的坚持下，旅行者 1 号在完成主要任务即将关闭相机之前，从 60 亿公里外（约 40.5 AU）回望地球，拍下了那张仅有 0.12 像素大小的「暗淡蓝点 (Pale Blue Dot)」照片。在这张逆光照片中，地球淹没在阳光散射的条纹里，只是一个小到几乎看不见的蓝色光点——所有的战争与和平、所有的文明兴衰、所有的爱与苦难，全都发生在这粒尘埃上。",
        "Sagan 在 1994 年出版的同名著作中写道：「看看那个光点，那就是这里，那就是家，那就是我们。在这上面，你所爱的每一个人，你认识的每一个人，你听说过的每一个人，曾经存在过的每一个人，都在那里度过了他们的一生。」这段文字被公认为 20 世纪最深刻的科学散文之一——它用宇宙学的尺度回击了人类的自负，却也用这份渺小反衬出地球的珍贵：在已知宇宙中，我们至今没有找到第二个存在生命的星球。这个 0.12 像素的蓝点，就是全部已知生命的家园。从 T0 可见宇宙到 T7 地球，整个尺度阶梯最终终结于这粒蓝色尘埃。",
      ],
    },
    {
      heading: "生物圈：唯一的样本",
    ...
    },
    {
      ...
      body: [
        ...
        "如果把地球 45 亿年的历史压缩成一天 24 小时，生命在凌晨 4 点左右出现，大氧化事件在上午 10 点让大气首次有氧，恐龙在晚上 10 点 40 分登场、在晚上 11 点 39 分灭绝，而整个人类文明——从最早的农业到今天——发生在最后的 0.2 秒。在这 0.2 秒里，我们已经让大气 CO₂ 浓度回到了 300 万年前的水平。地球不会在意——它经历过比这更剧烈的变化；但我们这层薄薄的文明壳，可能承受不起。",
      ],
    },
  ],
  sources: [
