  ...
  narrative: [
    ...
    },
    {
      ...
      body: [
        ...
        "Sagan 在 1994 年出版的同名著作中写道：「看看那个光点，那就是这里，那就是家，那就是我们。在这上面，你所爱的每一个人，你认识的每一个人，你听说过的每一个人，曾经存在过的每一个人，都在那里度过了他们的一生。」这段文字被公认为 20 世纪最深刻的科学散文之一——它用宇宙学的尺度回击了人类的自负，却也用这份渺小反衬出地球的珍贵：在已知宇宙中，我们至今没有找到第二个存在生命的星球。这个 0.12 像素的蓝点，就是全部已知生命的家园。",
      ],
    },
    {
      heading: "「淡蓝色圆点」",
