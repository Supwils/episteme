...
import T0 from "@/content/cosmos/T0";
import T1 from "@/content/cosmos/T1";
import T2 from "@/content/cosmos/T2";
import T3 from "@/content/cosmos/T3";
import T4 from "@/content/cosmos/T4";
import T5 from "@/content/cosmos/T5";
import T6 from "@/content/cosmos/T6";
import T7 from "@/content/cosmos/T7";
