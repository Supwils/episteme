...
import { domainAccent } from "@/lib/design/domain-accent";
...
const DOMAIN_CATALOG = [
  ...
  },
  {
    ...
    description:
      "从公元前10000年到公元2025年，覆盖全球六大洲。时间线、知识图谱、关系图谱、世界地图，以及历史人物与知识库文章。",
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <rect
          x="8"
  ...
  },
  {
    ...
    description:
      "从第一个有机分子到人类意识，探索40亿年生命演化的壮阔历程。覆盖地质时代、关键物种、大灭绝与关键科学家。",
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path
...
/** 领域的强调色取所属簇的国画颜料（T-DESIGN-01b），同簇领域靠学科印区分。 */
export const DOMAINS = DOMAIN_CATALOG.map((domain) => ({
  ...domain,
  ...domainAccent(domain.cluster),
}));
...
export const LATEST_UPDATES = [
  {
    ...
    domain: "奇趣知识",
    domainColor: "#e8b84a",
    title: "四百余张奇趣卡，跨学科巧合加到四十条",
    description:
      "二十二个学科每域至少十六张冷知识，外加四十条「看起来像串通、其实是同一套机制」的跨学科巧合。搜索能直接打到这些钩子。",
    date: "2026-09",
    href: "/curiosities",
  },
  {
