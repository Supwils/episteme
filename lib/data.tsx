// Generated by `pnpm gen-search-index` and committed — the portal stats strip
// reads from it so the numbers track the real index across content rounds.
...
export const DOMAINS = [
  {
    ...
    cluster: "cosmos-nature" as DomainClusterId,
    title: "物理学",
    titleEn: "Physics",
    description:
  ...
  },
  {
    ...
    description:
      "从公元前10000年到公元2025年，覆盖全球六大洲。时间线、知识图谱、关系图谱、世界地图与202位历史人物，104篇知识库文章。",
  ...
  },
  {
    ...
    stats: "117 哲学家 · 42 流派 · 340+ 篇文章",
  },
  {
    id: "arts" as const,
    cluster: "humanities-arts" as DomainClusterId,
    title: "艺术、建筑与美学",
    titleEn: "Arts, Architecture & Aesthetics",
    description:
      "从观看、材料与制作进入全球视觉文化——颜色如何作用于眼睛，风格如何在历史中形成，博物馆与市场又如何决定我们看见什么。涵盖视觉基础、媒介与材料、建筑与空间、全球艺术传统、美学与视觉文化、方法与数字前沿。",
    gradient: "linear-gradient(135deg, #b0785a 0%, #845a46 50%, #d3957e 100%)",
    glowColor: "#b0785a",
    bgAccent: "rgba(176, 120, 90, 0.08)",
    borderAccent: "rgba(176, 120, 90, 0.2)",
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path
          d="M18 5c-7.2 0-13 5.4-13 12 0 6.6 5.8 12 13 12 1.4 0 2.5-1.1 2.5-2.5 0-.6-.2-1.2-.6-1.7-.4-.5-.6-1.1-.6-1.7 0-1.4 1.1-2.5 2.5-2.5h3c4 0 6.2-2.5 6.2-6C31 9.4 25.2 5 18 5Z"
          stroke="#b0785a"
          strokeWidth="1.5"
          strokeLinejoin="round"
          opacity="0.6"
        />
        <circle cx="11.5" cy="13.5" r="1.8" fill="#d3957e" opacity="0.7" />
        <circle cx="18" cy="10.5" r="1.8" fill="#b0785a" opacity="0.75" />
        <circle cx="24.5" cy="13.5" r="1.8" fill="#845a46" opacity="0.8" />
        <circle cx="10.5" cy="20.5" r="1.8" fill="#d3957e" opacity="0.5" />
      </svg>
    ),
  ...
  },
  {
    ...
    cluster: "society-institutions" as DomainClusterId,
    title: "经济学",
    titleEn: "Economics",
    description:
    ...
    stats: "34 经济学家 · 17 理论 · 57 概念 · 12 流派",
  },
  {
  ...
  },
  {
    ...
    cluster: "society-institutions" as DomainClusterId,
    title: "法学",
    titleEn: "Comparative Law & Legal Systems",
    description:
      "规则如何界定权利、义务与公共权力——从宪法到合同，从法庭到习惯法。比较不同法律传统如何回答同一批人类社会的老问题：什么是公平的规则，以及谁来执行它。涵盖法律基础、公法、私法、刑法与程序、比较法律传统、全球与数字治理。",
    gradient: "linear-gradient(135deg, #a8843c 0%, #7d6330 50%, #c9a45c 100%)",
    glowColor: "#a8843c",
    bgAccent: "rgba(168, 132, 60, 0.08)",
    borderAccent: "rgba(168, 132, 60, 0.2)",
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path
          d="M18 6v4M18 8H7m11 0h11M18 8v18"
          stroke="#a8843c"
          strokeWidth="1.5"
          opacity="0.55"
        />
        <path
          d="M7 8l-3.5 7a3.8 3.8 0 0 0 7 0L7 8ZM29 8l-3.5 7a3.8 3.8 0 0 0 7 0L29 8Z"
          stroke="#c9a45c"
          strokeWidth="1.4"
          opacity="0.6"
        />
        <path d="M12 28h12" stroke="#a8843c" strokeWidth="1.6" opacity="0.6" />
      </svg>
    ),
    stats: "法律基础 · 公法 · 私法 · 刑法与程序 · 法律传统 · 全球治理",
  },
  {
  ...
  },
  {
    ...
    description:
      "人造物如何被可靠地造出来——从杠杆到电网，从钢材到芯片。工程是把科学变成能运转、能维护、能承受最坏情况的系统的手艺。涵盖工程基础、能源与动力、材料与制造、信息与机器、土木与建造、重大工程与伦理。",
    gradient: "linear-gradient(135deg, #8a919e 0%, #5f6772 50%, #aab2bd 100%)",
    glowColor: "#8a919e",
    bgAccent: "rgba(138, 145, 158, 0.08)",
    borderAccent: "rgba(138, 145, 158, 0.2)",
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path
          d="M18 5.5v3.6M18 26.9v3.6M5.5 18h3.6M26.9 18h3.6M9.2 9.2l2.5 2.5M24.3 24.3l2.5 2.5M26.8 9.2l-2.5 2.5M11.7 24.3l-2.5 2.5"
          stroke="#8a919e"
          strokeWidth="1.6"
          strokeLinecap="round"
          opacity="0.6"
        />
        <circle cx="18" cy="18" r="6.8" stroke="#8a919e" strokeWidth="1.5" opacity="0.65" />
        <circle cx="18" cy="18" r="2.4" stroke="#aab2bd" strokeWidth="1.4" opacity="0.75" />
        <circle cx="18" cy="18" r="0.9" fill="#5f6772" opacity="0.8" />
      </svg>
    ),
    stats: "工程基础 · 能源动力 · 材料制造 · 机器 · 土木建造 · 前沿伦理",
  },
];
...
export const STATS = [
  ...
  { value: SEARCH_STATS.documents, label: "可检索知识单元", suffix: "" },
  { value: SEARCH_STATS.articles, label: "深度文章", suffix: "" },
];
