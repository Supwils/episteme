// Daily-knowledge fact catalogs, split out of daily-selector.ts so the
// selection logic there stays readable. Data only — no behaviour.
import type { DailySelectedFact } from "./daily-selector";
...
export const MONTHLY_FACTS: Record<string, readonly string[]> = {
  "01": [
...
export const MATH_FACTS: readonly DailySelectedFact[] = [
  {
    title: "欧拉恒等式",
...
export const LIFE_SCIENCE_FACTS: readonly DailySelectedFact[] = [
  {
    title: "DNA的双螺旋",
...
export const COSMOLOGY_FACTS: readonly DailySelectedFact[] = [
  {
    title: "宇宙微波背景辐射",
...
export const ECONOMICS_FACTS: readonly DailySelectedFact[] = [
  {
    title: "看不见的手",
...
export const PSYCHOLOGY_FACTS: readonly DailySelectedFact[] = [
  {
    title: "经典条件反射",
...
export const COMPUTER_SCIENCE_FACTS: readonly DailySelectedFact[] = [
  {
    title: "图灵机",
    description:
...
export const POLITICAL_SCIENCE_FACTS: readonly DailySelectedFact[] = [
  {
    title: "利维坦与社会契约",
...
export const EARTH_SCIENCE_FACTS: readonly DailySelectedFact[] = [
  {
    title: "大陆漂移",
    description:
...
export const MEDICINE_FACTS: readonly DailySelectedFact[] = [
  {
    title: "细菌致病论",
    description:
...
export const CHEMISTRY_FACTS: readonly DailySelectedFact[] = [
  {
    title: "门捷列夫的周期表",
    description:
