...
const BY_SECTION: Record<string, ReligionLabInviteData> = {
  "religion-foundations": RITUAL,
  "texts-and-canons": CANON,
  "religious-history": MAP,
  "comparative-religion": MAP,
  "religion-and-society": RITUAL,
  secularization: SECULAR,
  frontier: SECULAR,
};

export function religionLabInvite(section: string, slug: string): ReligionLabInviteData {
