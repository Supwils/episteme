...
- **[[statistics|统计学]]**：机器学习和统计学有深度重叠，却长期是两种文化。统计学家 Leo Breiman 在 2001 年的名文《Statistical Modeling: The Two Cultures》里点破了这道分野：一派假设数据由某个可解释的随机模型生成，重推断与假设检验；另一派（如随机森林，正是 Breiman 本人的发明）把生成机制当作未知的黑箱，只求把数据拟合好、预测准。前者重可解释性，后者重预测性能。两个社区在 2010 年代深度融合，但这场"两种文化"之争至今仍是理解机器学习身份的一把钥匙。
