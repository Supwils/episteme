...
1995 年，四位软件工程师——Erich Gamma、Richard Helm、Ralph Johnson、John Vlissides——把这个想法引入软件设计，出版了《设计模式：可复用面向对象软件的基础》。这本书简称 GoF（Gang of Four，四人帮），定义了 23 种在面向对象设计中反复出现的模式，成为软件工程史上最有影响力的书籍之一。
