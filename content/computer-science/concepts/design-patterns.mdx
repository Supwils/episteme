...
- **建筑学**：设计模式直接从建筑学借用了"模式语言"的概念，Christopher Alexander 是间接创始人。耐人寻味的是，1996 年 Alexander 受邀在 OOPSLA 大会做主题演讲，他对软件界的借用态度复杂：在他看来，程序员学会了"模式目录"这层形式，却大多放下了他真正在意的那一面——模式语言本是为了生成"有生命的、对人友善的整体"，带着一种道德与审美的追求，而软件界更关心跑得快、占用少。换句话说，软件设计模式继承了亚历山大的形式，却未必继承他的灵魂。
