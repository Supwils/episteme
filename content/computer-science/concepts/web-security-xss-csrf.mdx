...
**第三方脚本的供应链风险**：2018 年 British Airways 数据泄露事件，攻击者篡改了支付页面用到的第三方 JavaScript 库（Modernizr），把约 38 万名客户提交的信用卡信息实时回传到攻击者服务器（监管认定受影响个人逾 40 万）——XSS 变种中最难防范的是这类供应链攻击（Magecart）。
