...
- **[[complexity|计算复杂性]]**：量子算法研究密切依赖计算复杂性理论——P vs NP 的量子类比（P vs BQP vs NP 等）是核心问题。
- **物理学**：量子算法利用量子叠加、纠缠和干涉——这些都是量子力学的基本特性，量子算法的设计思路与物理直觉高度相关。
- **[[information-theory|信息论]]**：量子信息论是经典信息论的延伸，处理量子比特（qubit）而非经典比特（bit）。Shannon 熵对应冯·诺伊曼熵（$S = -\text{Tr}(\rho \log \rho)$），量子信道容量和纠缠的量化是量子信息论的核心主题。
