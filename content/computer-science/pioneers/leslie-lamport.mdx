...
- **[[distributed-systems]]**：逻辑时钟、Paxos、拜占庭容错、顺序一致性，几乎覆盖了分布式系统理论的核心命题；兰波特的论文是理解任何现代分布式系统设计决策的必要背景。
...
- Lamport, L., Shostak, R., & Pease, M. *The Byzantine Generals Problem.* ACM TOCS 1(3), 1982.
