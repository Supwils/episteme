...
第一个误解："只要会听会说，识字读书自然会。" 这是把两件本质不同的事混为一谈。口语习得是人类演化出来的生物能力：只要置身于正常语言环境，几乎所有儿童都会不经教学地掌握口语（见[[first-language-acquisition]]）。文字却只有几千年的历史，人脑没有为阅读演化出专门的机制。

平克在《语言本能》里说得很形象：儿童生来就为声音做好了准备，文字则是一件必须费力安装的"可选配件"。德阿纳把这件配件的安装位置写清楚了：阅读占用左枕颞一处原本处理高分辨率形状的皮层，把它改造成对书面词形位置不变的视觉词形区——所谓神经元回收。阅读必须在教学中重建，而不是在接触中自发长成。

第二个误解："读写困难的孩子把字母看反了。" 镜像颠倒（把 b 写成 d）在学步儿童中普遍存在，与读写困难没有对应关系。谢维茨指出，早期识字阶段的反向书写不能当作诊断标志；发展性读写困难的核心困难不在眼睛，也不在视觉，而在语言层面——把书面符号映射到语音结构。这一点已有数十年的证据积累。

第三个误解："读写困难是智力或动机问题。" 定义本身就排除了这一点：发展性读写困难指的是在智力正常、教育机会充分的前提下出现的特异性阅读障碍。谢维茨 1998 年在《新英格兰医学杂志》的综述把学龄儿童中的流行率写在 5% 到 17.5% 之间：弹性来自切分阈值与识别标准，不是来自各地孩子突然变得不会读书。
...
在解码这一侧，科尔特哈特等人的双通路模型把"怎么念出来"拆成两条可分别损伤的路。词汇通路走整词识别，负责 yacht、pint 这类不规则词；非词汇通路走字素—音素规则，负责念出从未见过的假词。两条路在熟练阅读者那里并行，但入门教学首先要把非词汇通路建起来——没有它，谢尔自我教学假说里的"第一次独立拼读"就无从发生。
...
这并不等于汉字阅读是纯视觉技能。珀费蒂、刘颖与谭力海 2005 年的词项构成模型指出，汉字识别同样激活语音信息，只是形、音、义三项约束的时间进程与拼音文字不同。把汉字习得写成"靠图画记词"，既低估了部首与声旁的分析，也低估了语音的作用。汉语阅读仍然是语言任务，不是视力任务。
...
卡斯尔斯与科尔特哈特 1993 年在发展性读写困难里复现了习得性失读的两种剖面。语音性困难的儿童假词朗读差、不规则词相对好，对应非词汇通路建立失败；表层困难的儿童不规则词差、假词相对好，对应对整词正字法条目的掌握不足。多数儿童是混合或偏语音的，纯粹表层类型更少。区分的价值不在贴两种标签，而在说明"读不准"背后至少有两条可分离的机制。
...
谢维茨团队对康涅狄格纵向队列的功能成像给出了同一方向的脑证据：读写困难读者在念词和假词时，左后侧阅读网络——颞顶与枕颞——激活不足，右半球与额叶前部则出现代偿性升高。这不是眼睛把字母看反，而是左半球把形映射到音的回路没有被阅读经验充分募集。

汉字阅读也占用这块被回收的视觉词形区，并不另走一条纯视觉、右半球的路。跨语言成像表明，熟练阅读在不同文字系统中收敛到高度重叠的左半球网络；汉语读写困难的剖面可以更异质，语素意识的分量更重，但底层仍是语言网络的问题，不是视力问题。
...
- Castles, Anne, and Coltheart, Max. "Varieties of Developmental Dyslexia." *Cognition*, 47(2), 1993, 149–180.
- Coltheart, Max, Rastle, Kathleen, Perry, Conrad, Langdon, Robyn, and Ziegler, Johannes. "DRC: A Dual Route Cascaded Model of Visual Word Recognition and Reading Aloud." *Psychological Review*, 108(1), 2001, 204–256.
...
- Perfetti, Charles A., Liu, Ying, and Tan, Li Hai. "The Lexical Constituency Model: Some Implications of Research on Chinese for General Theories of Reading." *Psychological Review*, 112(1), 2005, 43–59.
- Share, David L. "Phonological Recoding and Self-Teaching: Sine Qua Non of Reading Acquisition." *Cognition*, 55(2), 1995, 151–218.
- Shaywitz, Sally E. "Dyslexia." *New England Journal of Medicine*, 338(5), 1998, 307–312.
- Shaywitz, Sally E., Shaywitz, Bennett A., Pugh, Kenneth R., et al. "Functional Disruption in the Organization of the Brain for Reading in Dyslexia." *Proceedings of the National Academy of Sciences*, 95(5), 1998, 2636–2641.
