...
1967 年，哲学家 H. Paul Grice 在哈佛大学的 William James 讲座上提出会话含义（conversational implicature）理论，讲稿 1975 年以〈[[grice-1975-logic-and-conversation|Logic and Conversation]]〉为题正式发表。他的核心想法是合作原则：交谈双方默认彼此合作，其中数量准则要求说话人"说得足够足量"。于是当说话人说了较弱的"一些"而没说较强的"全部"时，听话人反推：如果"全部"为真，他本该说"全部"；他没说，所以"全部"不成立。这条推理链条把"一些" strengthen（强化）成了"一些但非全部"。因为"一些/全部"这类词按信息强度排成等级——Larry Horn 在其 1972 年的 UCLA 博士论文中系统化了这种等级，后称 Horn scale——这类含义得名标量含义（scalar implicature）。塞尔同一卷从第五十九页起的[[searle-1975-indirect-speech-acts|间接言语行为]]问的是字面提问如何算作请求，不是标量含义的加工时间。

格赖斯其实列了四条准则，并不只有数量。质量准则要求不说自认虚假的话，也不断言缺乏证据的事情；关系准则要求相关；方式准则要求避免晦涩和歧义，并尽量简短、有序。

故意说反话，常常是让听者看见质量准则被明显违反，从而去找另一层意图。Horn 1984 年在乔治城大学圆桌会议论文里把这些准则收成两条：面向听者的 Q 原则要求尽量足量，面向说话者的 R 原则要求尽量省力。标量含义是 Q 原则的典型产物：选了弱项，就暗示更强项不成立。
...
若据此断言五岁儿童"还不会语用"，就把任务当成了能力本身。Katsos 与 Bishop 2011 年发表在《Cognition》上的研究给儿童三档评价：完全正确、有点可以、完全不行。

面对信息量不足的陈述，五岁儿童在对错二选一里常常接受，但在三档任务里会把这些句子放进中间档，而不是当成真话。他们听得出说话人可以更精确，只是不愿像成人那样把"不够好"直接判成"错"。作者称之为语用容忍：发展中的往往不是有无含义，而是何时把含义当成拒绝句子的理由。
...
还有第三条路线，并不站在默认论与关联论的加工对立上。Chierchia 2004 年主张，标量含义可以是语法运算：一个静默的穷尽算子把"一些"加强成"一些且非全部"，因此含义可以出现在嵌入位置，而不必等整句进入语用推理。Chierchia、Fox 与 Spector 2012 年把这一语法化方案写进语义学手册。实验能约束加工时间和语境条件，却不能单独决定含义该写进句法还是写进推理——这正是后文"不能推出什么"要守住的边界。

Degen 与 Tanenhaus 2015 年在《Cognitive Science》上提出制约式加工：含义是否出现，取决于替代形式有多容易被想到。若场景里数字更显眼，"一些"就不那么稳定地推出"非全部"；若说成 some of，强化又更容易出现。含义率因此不是词项的固定属性，而是语境、替代项和任务共同约束的结果。
...
默认论与关联论的对决，并不只发生在眼动实验室。Breheny、Katsos 与 Williams 2006 年同样发表在《Cognition》上的自定步速阅读实验，比较了上界语境与下界语境：当前者让"一些但非全部"真正有用时，读到 some 一类弱项的时间变长；在只需要"至少一些"的下界语境里，这份额外时间消失。含义并非一见到弱项就自动弹出，而是看当前问题要不要它。这与后来的眼动结果方向一致：即时与否取决于语境是否让强化值得计算。
...
- Horn, Laurence R. “Toward a New Taxonomy for Pragmatic Inference: Q-based and R-based Implicature.” In Deborah Schiffrin (ed.), *Meaning, Form, and Use in Context: Linguistic Applications*. Georgetown University Press, 1984: 11–42.
- Breheny, Richard, Napoleon Katsos, and John Williams. “Are Generalised Scalar Implicatures Generated by Default? An On-line Investigation of the Processing of Scalar Implicatures in English and Greek.” *Cognition* 100.3 (2006): 434–463.
- Chierchia, Gennaro. “Scalar Implicatures, Polarity Phenomena, and the Syntax/Pragmatics Interface.” In Adriana Belletti (ed.), *Structures and Beyond*. Oxford University Press, 2004: 39–103.
- Chierchia, Gennaro, Danny Fox, and Benjamin Spector. “Scalar Implicature as a Grammatical Phenomenon.” In Claudia Maienborn, Klaus von Heusinger, and Paul Portner (eds.), *Semantics: An International Handbook of Natural Language Meaning*, vol. 3. De Gruyter Mouton, 2012: 2297–2331.
- Katsos, Napoleon, and Dorothy V. M. Bishop. “Pragmatic Tolerance: Implications for the Acquisition of Informativeness and Implicature.” *Cognition* 120.1 (2011): 67–81.
- Degen, Judith, and Michael K. Tanenhaus. “Processing Scalar Implicature: A Constraint-Based Approach.” *Cognitive Science* 39.4 (2015): 667–710.
