...
- **[[sign-language-structure|手语的空间语法]]** 说明手语依靠手、脸、身体与空间共同编码。模型若只识别手形，就像口语系统只识别元音；语言学结构应决定传感和标注，而非由现成视觉模型决定问题。摄像头对准了手，不等于对准了语法。
- **[[algorithmic-discrimination-audits|算法歧视审计]]** 提供群体误差、流程影响与救济框架。手语系统需要签者独立和最差群体评测，同时审计部署机构是否用它降低原有无障碍责任。平均准确率掩盖的，往往是最依赖手语的那一组人。
- **[[multimodal-learning|多模态学习]]** 研究不同信号的时间与语义对齐。手语提供严格测试：模型必须整合快速手部运动、较慢身体姿态与语篇空间，单帧分类不足以完成任务。一帧里的手形，解释不了空间里的指称。
- **[[language-identity-power|语言、身份与权力]]** 揭示把手语描述成残缺口语会产生制度后果。聋人主导研究不仅改善样本代表性，也改变哪些能力被视为值得建设，因而改变技术权力分配。谁定义任务，谁就定义什么叫成功的翻译。

- **[[what-is-learning|学习是什么]]** 手语能力在课堂、家庭和社群里被不同制度计算。识别准确率上升，不等于聋人学生获得了更好的学习条件。课堂翻译变快，并不自动改变考试与师资怎样计算手语。

- **[[fairness-in-ml|机器学习公平]]** 平均准确率会把最差签者藏进总体。公平指标若不按签者独立切分，无障碍承诺就无法被核对。
