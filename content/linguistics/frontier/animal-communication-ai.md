...
- **[[language-evolution|语言能力如何演化]]** 研究人类语言的生物与文化前提。动物组合系统可检验哪些成分早于人类出现，但相似结构可能独立演化，不能直接画成通往人类语言的阶梯。同构不是谱系，阶梯图常常是后来画上去的。
- **[[animal-behavior|动物行为]]** 提供情境、个体识别和实验设计。声音模式只有与真实行为和社会关系连接才可能获得功能解释；人工智能不能替代长期自然史观察。聚类漂亮、情境缺失，功能就还是猜测。
- **[[machine-learning-data|机器学习数据]]** 揭示采样和标签决定模型能学到什么。录音数量巨大但情境稀薄时，扩大模型不一定提高语义；增加高质量同步行为数据可能更有价值。小时数堆高，标签仍是“叫声”，模型学到的是频谱，不是意义。
- **[[philosophy-of-language|语言哲学]]** 区分信号、意向、指称与意义。动物研究迫使这些概念接受经验检验：若意义依赖共同实践，翻译就不能只做声学字典，还要理解一个物种的生活形式。词典对上了声，对不上谁在对谁做什么。

- **[[speech-perception|言语知觉]]** 提醒范畴边界依赖听者的经验。把聚类边界写成动物的“音位”，是把人类听感设备搬进了另一物种的生活。听感仪器属于人，范畴边界不能直接捐赠给鲸鱼。

- **[[acoustic-phonetics|声学语音学]]** 把叫声先写成可测量的时间与频谱。没有这一层，聚类标签就还只是文件名。
