...
DICE 的优势在于结构简洁、透明、可复现。诺德豪斯持续更新这一模型，2023 年版本（DICE-2023）在更新了碳循环、损害估计和不确定性处理后，对 2025 年的 SCC 估算为约 97 美元/吨 CO₂（以 3% 折现率为基础）（Barrage & Nordhaus, 2023）。
...
Pindyck（2013）在《气候变化政策：对待不确定性应该谨慎》一文中直接把 IAM 描述为"不太可信、几乎肯定会产生误导性结果"的工具。
...
- Barrage, L., & Nordhaus, W. D. (2023). Policies, Projections, and the Social Cost of Carbon: Results from the DICE-2023 Model. _Proceedings of the National Academy of Sciences_, 121(13).
