...
relatedExperiments: [asch-conformity]
relatedTheorists: [henri-tajfel, john-turner]
related: [groupthink, bystander-effect, obedience-authority, fundamental-attribution-error]
status: published
updated: 2026-06-16
---
...
当群体认同受到威胁时——例如内群体被贬低或地位受到挑战——人们会表现出更强的群体忠诚和对外群体的敌意。布兰斯科姆（Nyla Branscombe）等人 1999 年区分了社会认同威胁的不同类型，并指出：高度认同某群体的人，一旦感到群体地位受威胁，就更可能以防御性的群体偏见来回应。
...
- **同域延伸**：当群体认同压倒个人判断，就走向 [[groupthink]]（群体思维）；它也是 [[bystander-effect]]（旁观者效应）中"群体责任分散"和 [[fundamental-attribution-error]]（基本归因错误）中"外群体同质化"的共同根源
