...
- **哲学（科学哲学）**：复制危机重新激活了可证伪性、辅助假设与证据积累的讨论。库恩和拉卡托斯提供了描述共同体规范与研究纲领变化的词汇，但复制数据本身不会直接证明某一种[[philosophy-of-science|科学哲学]]。

- **统计学**：围绕 p 值的争论推动了对效应量、区间估计、贝叶斯方法、等效检验和决策阈值的更细致使用。Benjamin 等 72 位作者在 2018 年发表文章，建议把新发现的默认阈值从 p = 0.05 调整为 p = 0.005；这是一项有条件的制度提案，而不是[[statistics|统计学]]界已接受的新定律[^benjamin]。

- **经济学**：行为经济学领域有许多与[[social-psychology|社会心理学]]重叠的研究（锚定效应、框架效应等），也受到了复制危机的冲击。部分被视为政策依据的行为经济学效应在大样本研究中表现出比原始研究小得多的效应量。
