...
- **[[evidence-and-proof|证据与证明]]** 区分真实性门槛与最终证明力。一段影像被认证，只表示足以交由事实裁判者评价，不代表其中叙事自动为真；语境、完整性和反证仍然重要。认证通过的是文件，不是镜头前发生过的事。
- **[[digital-signatures|数字签名]]** 能发现内容在签名后是否改变并认证签名主体。它不能证明镜头前场景真实，也不能防止主体签署误导内容；密码学保证必须与采集和组织程序连接。签名证明谁在何时封存，不证明封存前有没有被摆拍。
- **[[generative-art-authorship-provenance|生成式艺术的作者与来源]]** 面对同一内容履历基础设施，但目的不同。艺术重视创作过程与授权，法庭重视可采与责任；共同标准应允许不同披露层级，而非一套标签覆盖全部语境。同一枚来源标签，在展厅是作者声明，在法庭是可质证的主张。
- **[[speech-technology|言语技术]]** 说明语音克隆和识别受说话人、噪声与语言资源影响。音频鉴定若忽略方言和压缩条件，模型误差会被错误包装成说话人身份事实。低资源口音上的高置信度，常常是训练偏差，不是更强的同一认定。

- **[[information-asymmetry|信息不对称]]** 合成媒体让查验成本落到被指认的一方。认证基础设施若不能被对方使用，真实门槛就会变成有资源者的私人工具。
