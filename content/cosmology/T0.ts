...
const content: TierContent = {
  ...
  dataCards: [
    ...
    {
      label: "暗能量状态方程 (常数 w)",
      latinLabel: "Dark energy w (constant)",
      value: "w ≈ −1",
      hint: "wCDM 拟合 · 与 Λ 一致 · 动力学拟合见 w₀w_a 卡片",
    },
    {
      label: "H₀ 张力",
    ...
    },
    {
      ...
      value: "w₀ ≈ −0.7 · w_a ≈ −1",
      hint: "DESI DR2 BAO + CMB + SN · 2025 · 偏离 Λ 2.8–4.2σ",
    },
    {
      label: "JWST 最远确认星系",
      latinLabel: "JWST most distant galaxy",
      value: "z ≈ 14.44",
      hint: "MoM-z14 · 宇宙 ~2.8 亿岁 · 2025",
    },
    {
      label: "S₈ 张力",
  ...
  markers: [
    ...
    },
    {
      ...
      description:
        "Guth 1981 提出的暴胀模型在 10⁻³⁶ — 10⁻³² s 把宇宙拉伸 ≥ 60 个 e-folds，把原本因果相连的区域吹胀成今天的可观测宇宙。它预言原初引力波会在 CMB 上留下 B-mode 偏振。BICEP/Keck 2021 把张标比 r 压到 < 0.036 (95% CL)，已开始排除一类经典暴胀势 —— 这是检验暴胀最直接的现存窗口；地面旗舰 CMB-S4 已于 2025 年 7 月取消，接力棒转向 Simons Observatory 与 LiteBIRD (2032)，将在 2030 年代把灵敏度推进一个数量级。",
      data: [
