...
中国天眼（FAST）口径500米，是世界上最大的单口径射电望远镜，在 Arecibo 原可见天区的灵敏度约为 Arecibo 的两倍（在 Arecibo 无法覆盖的天区可达约十倍）。CPTA 仅用约3.4年（41个月）的数据就达到了约 4.6σ 的显著性，显示 FAST 将在未来 PTA 科学中扮演核心角色。
