...
其原理是：穿过地球与各颗脉冲星之间空间的引力波，会系统性地延迟或提前脉冲到达时间，且不同方向上的延迟存在特征性的角关联——**赫林斯-唐斯（Hellings-Downs）曲线**。2023 年，全球多个 PTA 团队同时宣布，首次以置信度超过 $4\sigma$ 的水平探测到疑似**纳赫兹引力波背景**（gravitational wave background, GWB）的信号，引发了广泛关注。
...
宇宙中无数个超大质量黑洞双星（质量 $10^7$–$10^{10}\,M_\odot$）在漫长的轨道衰减过程中，持续发射纳赫兹引力波，叠加形成随机背景。这是目前最受支持的解释，也与信号振幅量级基本一致（Phinney 2001，_The Astrophysical Journal Letters_，554，L37）。
