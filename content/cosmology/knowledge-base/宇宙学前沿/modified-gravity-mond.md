...
- **暗物质直接探测**（[[dark-matter-direct-detection|暗物质直接探测的"沉默]]）：MOND 是暗物质粒子搜索的竞争性替代框架
- **暗物质与暗能量**（[[暗物质与暗能量]]）：宇宙学证据的综述
- **引力透镜**（[[引力透镜]]）：子弹星系团和其他透镜系统对 MOND 的约束
- **引力波天文学**（[[引力波天文学]]）：GW170817 对相对论性 MOND 的约束
