...
这篇要写的不是元素表，而是钟和层：燃料更多为什么活得更短，洋葱壳为什么一层套一层，铁核为什么是静静燃烧的终点。核反应的截面与丰度峰见[[恒星核合成]]；氦闪、第三次挖掘和行星状星云是中低质量星的晚年，见[[red-giants-agb|红巨星与渐近巨星支]]，这里不重写。四条结构方程怎样联立求解，见[[stellar-structure-hydrostatic-equilibrium|恒星结构与流体静力平衡]]那一篇；本文只取大质量这一支的时标、分层和铁核终点。
...
质光关系所以这么陡，是因为大质量星靠碳氮氧循环烧氢，产能率随温度的十六到二十次方上涨，核心必须对流才能把能量及时搬走。辐射压在总压强里所占的份额也随质量上升，星体必须更亮才能顶住自引力，于是光度比质量涨得更快。油箱按质量近似线性增加，发动机功率却按接近三点五次方增加，寿命也就只能按负指数掉下去。把这件事说成星星挥霍青春，只是便于记忆；真正起作用的是流体静力平衡加上核反应对温度极度敏感之后的代数结果。
...
把各阶段的时标读成空间上的分层：外层氢壳还在燃烧的时候，核心早已换成氦、碳、氧、硅，最内层停在铁族。洋葱不是把整颗星依次替换成下一种燃料，而是灰烬变成下一层的燃料，外层炉子还亮着、内层已经在下一档。硅燃烧只剩大约一天，是因为结合能曲线在铁附近变平，加上中微子把能量直接带走，两件事叠在一起，才把数百万年压成几乎无法预报的窗口。
...
碳氮氧循环把产能挤在核心最热处，温度梯度超过绝热梯度，于是大质量主序星的氢燃烧核是对流核，物质被充分搅拌。氢一耗尽，对流核留下的氦核几乎是均匀的，氢壳点燃来得很快，不会像太阳那样先走过漫长的亚巨星调整。主序寿命公式里的负二点五次方，已经把这份挥霍写进指数；二十五倍太阳质量大约六百万年、一百倍大约三百万年，用的就是上文那条标度。
...
每一层壳都是上一阶段的灰在新的温度上被重新点燃：氦灰在氢壳底下烧成碳氧，碳氧灰再在更深更热处烧成氖镁，如此直到硅。壳与壳之间有熵和平均分子量的跳变，对流不容易把它们彻底搅匀，所以临终结构看起来像分层的洋葱，而不是均匀的一团铁。表里的温度和时标对应大约二十五倍太阳质量的单星模型，金属丰度、自转和双星质量转移都会改各层的质量，但越往里时标越短、最内层停在铁族这一条不改。

### 铁核——核燃烧的终点

铁族附近是核子平均结合能的峰区，因此铁核燃烧不产生能量而消耗能量。一旦核心积累的铁核质量超过**钱德拉塞卡质量**（约 $1.4\,M_\odot$，考虑有限温度和中子化后修正为约 $1.2$–$1.5\,M_\odot$），电子简并压无法再维持流体静力学平衡，铁核在约 **0.1 秒**内坍缩，速度达到光速的 $\sim 25\%$。

铁核长大的同时，光致分解开始拆已经结合的核，电子俘获把质子变成中子并放出中微子，两条路都从压强账里抽走能量。电子简并压本身几乎不随温度升高而变强，所以铁核可以一边丢能量一边仍被同一份量子压强托着，直到质量越过那条上限。超过上限之后，支撑在不到一秒内失效，这是核燃烧终点在流体静力上的表现，不是燃料用完那么简单。

坍缩之后激波能否把整颗星炸开，是[[core-collapse-supernovae|核心坍缩超新星]]的机制问题，本文停在静静燃烧在这里结束。留下中子星还是黑洞，要等落回质量和核物质状态方程一起决定，并不能单凭初始质量读出答案。
...
恒星风把外层剥掉，等于在爆炸前改写洋葱的外几层：氢包层若被剥光，超新星光谱里就看不到氢线，分类就会从带氢的二型变成几乎无氢的一型。金属丰度越高，辐射驱动风越强，剥得越狠，高红移低金属环境则更容易把大质量核完整留到坍缩，从而留下更重的黑洞。风损耗不是写完核燃烧再贴上去的修饰，而是把初始质量翻译成最后残骸质量时必须经过的一层。
...
超射参数只要差上那么一点点，氦核质量就会差出一截，铁核能不能越过钱德拉塞卡上限也会跟着改变。观测能看见的是表面的光度和温度，核心结构却藏在对流边界的假设里，所以前体预测到爆炸前十年仍然很虚。这件事不能推给超级计算机还不够快，而是对流边界上的混合物理本身还没有从第一原理上被钉死。
...
碳氧到铁族的产量由这些壳层的质量和爆发时冲击波扫过的条件决定，反应网本身见[[恒星核合成]]。本文只强调一件结构事实：没有短到百万年量级的大质量寿命，就没有足够快的金属增丰；没有铁核这个终点，就不会有核心坍缩这条通道。
...
- Ekström, S. et al. (2012). Grids of stellar models with rotation. I. Models from 0.8 to 120 $M_\odot$ at solar metallicity ($Z = 0.014$). _Astronomy & Astrophysics_, 537, A146.
