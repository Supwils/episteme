...
- **宇宙距离阶梯**（[[宇宙距离阶梯]]）：造父变星是距离阶梯中间的关键梯级，连接视差和 Ia 型超新星
- **赫罗图**（[[hertzsprung-russell-diagram|赫罗图]]）：造父变星位于赫罗图的不稳定带，是恒星演化轨迹跨越不稳定带时产生的脉动现象
- **星系形成与演化**（[[星系形成与演化]]）：哈勃利用造父变星确认河外星系的存在，开创了现代星系天文学
- **宇宙微波背景**（[[宇宙微波背景|宇宙微波背景辐射]]）：CMB 给出的哈勃常数与造父变星链测量的哈勃常数存在"哈勃张力"
