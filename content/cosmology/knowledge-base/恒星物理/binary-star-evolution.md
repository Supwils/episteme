...
- **大质量恒星演化**（[[massive-star-evolution|大质量恒星演化]]）：大质量双星是 BBH 和 NSBH 的前体
- **白矮星**（[[white-dwarfs|白矮星]]）：白矮星在 SD 和 DD 通道中是 Ia 型超新星前体
- **中子星与脉冲星**（[[中子星与脉冲星]]）：双星吸积产生毫秒脉冲星
- **引力波天文学**（[[引力波天文学]]）：双致密星并合是主要引力波波源
- **恒星金属丰度与化学演化**（[[stellar-metallicity-chemical-evolution|恒星金属丰度与化学演化]]）：Ia 型超新星和中子星并合是 Fe 和 r 过程元素的来源
