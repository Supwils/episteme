...
它连接工程学：系统工程决定任务是否能反复执行。它连接医学：深空辐射、低重力和隔离环境直接影响人体。它连接政治学：深空基础设施涉及国际合作、资源规则和战略竞争。它连接经济学：一次性旗帜任务和可持续太空经济是两种完全不同的成本结构。它连接天体生物学：火星、月球和小行星任务会改变我们采样、污染控制和生命探测的能力。
