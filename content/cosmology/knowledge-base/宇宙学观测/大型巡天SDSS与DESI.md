...
**重子声学振荡（BAO）的统计探测**：SDSS 于 2005 年（Eisenstein 等，ApJ 633，560）在 46958 个亮红星系样本的两点相关函数中首次探测到 BAO 峰（与声波水平约 100 Mpc/$h$ 的特征尺度对应），提供了测量暗能量的宇宙标准尺。
...
**暗能量巡天（DES，Dark Energy Survey）** 用智利 Blanco 4 m 望远镜的 570 个 CCD 相机（DECam，视场 $3 \, \text{deg}^2$）在 5 个光学/近红外波段对南天约 5000 平方度进行成像，2013—2019 年运行。DES 5 年完整数据约束（结合 WL、星系团、BAO、超新星）的宇宙学结果与 Planck CMB 结果在 $\Omega_m$-$\sigma_8$ 平面存在轻微（约 2$\sigma$）但尚不显著的张力（DES Collaboration，2022，PRD 105，023520）。
