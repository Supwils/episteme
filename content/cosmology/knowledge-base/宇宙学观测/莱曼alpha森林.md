...
- **星系际介质**（[[星系际介质]]）：Ly$\alpha$ 森林是IGM的直接采样
- **大型巡天 SDSS 与 DESI**（[[大型巡天SDSS与DESI|大型巡天：SDSS与DESI]]）：BOSS 利用 Ly$\alpha$ 森林测量 BAO
- **宇宙大尺度结构形成**（[[大尺度结构形成]]）：Ly$\alpha$ 功率谱约束小尺度结构
- **重子声学振荡**（[[重子声学振荡]]）：高红移 BAO 通过 Ly$\alpha$ 森林探测
