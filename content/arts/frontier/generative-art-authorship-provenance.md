...
- **[[generative-art-and-ai|生成艺术与人工智能]]** 提供了从规则系统到扩散模型的媒介史。前沿问题不再是模型能不能出图，而是创作决定如何分布在数据、模型、界面与艺术家之间；由此可预测，未来作品说明会越来越像软件版本记录，而不只是材料标签。版本记录能核验，风格标签不能。
- **[[intellectual-property|知识产权]]** 区分思想、风格、具体表达与汇编选择。生成过程迫使法律为“局部人类贡献”寻找可执行边界；如果判准有效，相似流程的登记结果应更稳定，而不应取决于是否使用了“AI”这个标签。工具名称变了、贡献结构没变，权利答案不应跟着营销词变。
- **[[provenance-and-attribution|来源与归属研究]]** 说明来源从来不是一枚签名，而是一组可相互校验的物证和文献。数字签名只是新增一种证据；一旦它与交易史、创作档案冲突，研究者仍须解释冲突，不能让密码学取代鉴定。签名与档案打架时，要解释的是冲突，不是更相信芯片。
- **[[digital-rights-and-privacy|数字权利与隐私]]** 揭示透明的另一面：越完整的创作日志越可能泄露个人信息。可持续方案必须允许最小披露、撤销与访问分级，否则“可信来源”会变成对创作者的持续监控。日志越全，被追踪的就可能是人，而不只是文件。

- **[[evidence-and-proof|证据与证明]]** 来源凭证只跨过真实性门槛。法庭或登记机关仍要问：这份日志能不能被对方拆开、对质、推翻。
