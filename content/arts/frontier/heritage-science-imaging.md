...
- **[[conservation-science|艺术保护科学]]** 提供材料老化、取样和预防性保护的基础。成像并不直接告诉修复者该做什么；只有把元素与层序映射到具体劣化机制，才可能改变温湿度、照明或清洗方案。图谱漂亮，若接不上劣化机制，仍只是一张更贵的照片。
- **[[electron-microscopy-and-surface-analysis|电子显微与表面分析]]** 以极高空间分辨率检验宏观成像提出的假说。宏观扫描负责发现区域模式，微区分析负责识别晶相与层序；两者一致时，归因才从相关走向更强证据。宏观看见一块亮斑，微区才能说它是不是那一层颜料。
- **[[provenance-and-attribution|来源与归属研究]]** 把材料证据放回档案和风格史。某种颜料出现时间可以否定一个年代，却很少单独证明作者；可检验推论是，多源证据融合应提高排除错误归属的能力，而非制造更多确定口吻。能排除的年代，仍不是能签名的作者。
- **[[hypothesis-testing|假设检验]]** 要求研究者事先区分竞争解释，例如“底层是改稿”与“底层是后来修补”。扫描参数和取样位置应服务于区分假设；如果任何结果都能被解释成惊人发现，这套方法就没有证伪力。先写互斥假设，扫描才不是寻宝。

- **[[bayesian-inference|贝叶斯推断]]** 要求把颜料年代、层序和档案先验分开更新。扫描结果若被用来同时证明作者与年代，同一份似然就被用了两次。
