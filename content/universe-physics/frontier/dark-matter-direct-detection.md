...
- **宇宙学与大尺度结构**：直接探测实验搜寻的 WIMP 质量范围（1 GeV–10 TeV）与宇宙学上"冷暗物质"（cold dark matter）的定义一致。如果最终证明 WIMP 不存在，需要的不只是粒子物理模型的修改，而是整个冷暗物质宇宙学的深层修正。与[[哈勃张力]]问题可能有内在联系：某些解决 Hubble 张力的模型（如相互作用暗能量、早期暗能量）会对暗物质的性质做出额外预言。
