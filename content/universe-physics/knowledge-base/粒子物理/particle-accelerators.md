...
1987年，费米实验室的Tevatron（万亿电子伏特加速器）建成，是第一台将质子加速到TeV能标的机器（质心能量 $\sqrt{s} = 1.96\ \text{TeV}$），1995年在此发现了顶夸克。

2008年，CERN的大型强子对撞机（LHC，Large Hadron Collider）完成建造，周长约27 km，使用超导磁铁（铌钛合金，约8.3 T，运行温度约1.9 K，比外太空还冷）。2012年，LHC在 $\sqrt{s} = 8\ \text{TeV}$ 下发现希格斯玻色子；2022年Run 3以 $\sqrt{s} = 13.6\ \text{TeV}$ 运行，是目前世界最高能量的对撞机。
...
- **卡2**：LHC（周长27 km，运行温度约1.9 K，比外太空更冷）于2012年以 $\sqrt{s} = 8$ TeV发现希格斯玻色子，2022年Run 3升级到 $\sqrt{s} = 13.6$ TeV。
- **卡3**：万维网（WWW）由CERN的蒂姆·伯纳斯-李于1989年发明，最初用于管理LHC实验数据。
- **卡4**：全球约35000台粒子加速器中，约99%用于医疗（质子治疗）、工业和同步辐射光源，用于基础研究的不足1%。

## 引用

> "我们并不是在寻找一种特定的粒子——我们是在用已知的物理定律去探测自然界在更高能标上的行为，看看她在那里隐藏了什么。" — 法比奥拉·吉亚诺蒂（CERN总干事，2012年）

> "每一台加速器都是一个时代物理学的边界——建造下一台是因为我们还不知道边界那边是什么。" — 费曼（_The Feynman Lectures on Physics_ 讲稿附言）

## 延伸阅读

1. Lawrence, Ernest O. "The Production of High Speed Light Ions without the Use of High Voltages." _Physical Review_, 40(1): 19–35, 1932.
2. Wilson, Robert R. "Radiological Use of Fast Protons." _Radiology_, 47(5): 487–491, 1946.
3. Evans, Lyndon, ed. _The Large Hadron Collider: A Marvel of Technology_. EPFL Press, 2009.
4. Wiedemann, Helmut. _Particle Accelerator Physics_ (4th ed.). Springer, 2015.
5. Myers, Stephen, and Herwig Schopper, eds. _Particle Physics Reference Library, Volume 3: Accelerators and Colliders_. Springer Open, 2020.
6. 张闯. 《粒子加速器物理》. 中国科学技术大学出版社, 2014.
