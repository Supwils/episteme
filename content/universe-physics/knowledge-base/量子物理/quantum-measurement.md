...
**客观坍缩模型（GRW，Penrose）**：在薛定谔方程中加入随机的非线性项，使得宏观系统的叠加态在极短时间内自发坍缩。GRW（Ghirardi-Rimini-Weber，1986）模型预言了轻微偏离标准量子力学的效应，原则上可通过实验检验——但当前精度尚不足以区分。
