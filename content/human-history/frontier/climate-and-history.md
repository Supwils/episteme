...
- **[[ancient-dna-revolution|古DNA革命]]**：人群在气候冲击后的迁徙，既可以在气候记录中看到时序，也可以在基因组记录中看到人群替换信号，两者的交叉验证是当前重要方法。例如，欧洲青铜时代的人群流动与公元前 3000 年前后的气候波动有部分时序重叠，古 DNA 与树木年轮数据的联合分析正在成为新标准。
- **[[digital-humanities-big-data-history|数字人文与大数据史学]]**：Seshat 数据库将气候代理数据和政体社会复杂度指标并排纳入同一分析框架，尝试用计量方法提取气候-社会关联的跨文化规律——这是两个前沿领域的直接交汇。
