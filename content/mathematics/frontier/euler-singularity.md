...
2014 年，Thomas Hou 与其博士后 Guo Luo 在《CPAM》（Communications on Pure and Applied Mathematics）发表了一项重要的数值研究，在轴对称设置下（带圆柱边界）发现了非常令人信服的有限时间爆破的**数值证据**。
...
| 时间 | 工作                      | 结果                                            |
| ---- | ------------------------- | ----------------------------------------------- |
| 2014 | Hou & Luo, CPAM           | 轴对称欧拉方程数值爆破证据（带边界）            |
