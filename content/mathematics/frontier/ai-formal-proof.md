...
2014 年，"四色定理"的 Lean 验证被完成（原计算机辅助证明来自 1976 年，一直有人怀疑那 1936 种情形的枚举有漏洞）。2021 年，"素数定理"的 Lean 证明库（Mathlib）条目被确认。随着 Mathlib 库中的已形式化定理数量在 2024 年前后突破 20 万条，Lean 4 事实上成为了数学知识的另一种编码格式。
