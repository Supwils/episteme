...
import {
  ...
  BASE_W, BASE_H,
} from '@/components/atlas/atlas-draw';
import { setupEventHandlers } from '@/components/atlas/atlas-handlers';
import { refreshOverview as refreshOverviewImpl, showScenePanel as showScenePanelImpl } from '@/components/atlas/atlas-ui';
...
export default function AtlasCanvas() {
  ...
  const doShowScenePanel = useCallback((topic: any) => {
  ...
  }, [draw, markDirty, selectEra, selectTopic, returnToEra, returnToRoot, zoomTo, refreshOverview, updateBreadcrumb]);
