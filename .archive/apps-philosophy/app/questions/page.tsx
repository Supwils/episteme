    ...
    <div className="mx-auto max-w-[1400px] px-6 py-16">
      <header className="mb-12">
        ...
        <p className="text-fg-secondary max-w-xl text-sm leading-relaxed md:text-base">
          {questions.length} 个贯穿哲学史的根本问题，从古希腊到当代前沿。每一个都曾让最伟大的头脑穷尽一生。
        </p>
      </header>
        ...
        {questions.map((q, i) => {
          ...
          return (
            <Link
              ...
              className="group border-border-faint bg-bg-panel relative flex flex-col gap-4 overflow-hidden border p-6 backdrop-blur-md transition-all duration-500 hover:-translate-y-1 hover:border-fg-disabled/30 hover:shadow-[0_8px_32px_rgba(200,164,90,0.06)]"
              style={{
            ...
            >
                  ...
                  <div className="flex gap-0.5">
                    {[1, 2, 3].map((d) => (
                      <span
                        ...
                        style={{
                          backgroundColor:
                            d <= depth ? fieldColor : "var(--color-fg-disabled)",
                        }}
                      />
                    ))}
                  </div>
              ...
              <h2 className="font-display text-fg-primary relative text-xl font-semibold leading-snug transition-colors duration-300 group-hover:text-accent-gold">
                {q.title}
              </h2>
