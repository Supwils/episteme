...
export const QUICK_LINKS = [
  { href: "/thinkers", label: "哲学家", icon: "Φ", description: "50 位东西方哲学家的生平、思想与遗产", accent: "#6ad0ff" },
  ...
  { href: "/experiments", label: "思想实验", icon: "∞", description: "16 个改变哲学进程的思想实验", accent: "#a88adf" },
