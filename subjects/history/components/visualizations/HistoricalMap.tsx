...
const CONTINENT_PATHS = {
  africa:
    "M 480 280 L 520 260 L 560 250 L 580 270 L 590 310 L 580 360 L 560 400 L 540 430 L 510 440 L 490 420 L 480 380 L 470 340 L 475 300 Z",
  europe:
    "M 480 180 L 520 170 L 560 175 L 580 190 L 570 210 L 550 220 L 530 230 L 510 235 L 490 230 L 480 210 Z",
  ...
  northAmerica:
    "M 120 120 L 180 100 L 240 110 L 280 140 L 290 180 L 270 220 L 240 250 L 200 260 L 160 250 L 130 220 L 120 180 Z",
  southAmerica:
    "M 220 300 L 260 290 L 290 310 L 300 350 L 290 400 L 270 440 L 240 460 L 220 440 L 210 400 L 200 360 L 210 330 Z",
...
const CIVILIZATIONS: Civilization[] = [
  {
    ...
    startYear: -3000,
    endYear: -30,
    path: "M 520 270 L 540 260 L 555 265 L 550 285 L 535 290 L 520 285 Z",
  },
  {
    id: "mesopotamia",
    name: "Mesopotamia",
    ...
    startYear: -3500,
    endYear: -539,
    path: "M 580 220 L 600 210 L 615 215 L 610 235 L 595 240 L 580 235 Z",
  },
  {
    id: "indus",
    name: "Indus",
    ...
    startYear: -3300,
    endYear: -1300,
    path: "M 650 230 L 670 220 L 685 225 L 680 245 L 665 250 L 650 245 Z",
  },
  {
    id: "china",
    name: "China",
    ...
    startYear: -2070,
    endYear: 220,
    path: "M 720 180 L 750 170 L 770 180 L 765 210 L 740 220 L 720 210 Z",
  },
  {
    id: "greece",
    name: "Greece",
    ...
    startYear: -800,
    endYear: -146,
    path: "M 540 210 L 555 205 L 560 215 L 555 225 L 545 225 L 540 220 Z",
  },
  {
    id: "rome",
    name: "Rome",
    ...
    startYear: -753,
    endYear: 476,
    path: "M 520 200 L 540 195 L 550 205 L 545 220 L 530 225 L 520 215 Z",
  },
  {
    id: "byzantine",
    name: "Byzantine",
    ...
    startYear: 330,
    endYear: 1453,
    path: "M 550 200 L 570 195 L 580 205 L 575 220 L 560 225 L 550 215 Z",
  },
  {
    id: "islamic",
    ...
    startYear: 750,
    endYear: 1258,
    path: "M 570 220 L 610 210 L 640 220 L 635 250 L 600 260 L 570 250 Z",
  },
  {
    id: "tang",
    name: "Tang Dynasty",
    ...
    startYear: 618,
    endYear: 907,
    path: "M 710 170 L 740 160 L 760 170 L 755 200 L 730 210 L 710 200 Z",
  },
  {
    id: "hre",
    ...
    startYear: 800,
    endYear: 1806,
    path: "M 510 180 L 530 175 L 540 185 L 535 200 L 520 205 L 510 195 Z",
  },
  {
    id: "ottoman",
    name: "Ottoman",
    ...
    startYear: 1299,
    endYear: 1922,
    path: "M 550 200 L 580 195 L 590 210 L 585 230 L 565 235 L 550 225 Z",
  },
  {
    id: "spanish",
    name: "Spanish Empire",
    ...
    startYear: 1492,
    endYear: 1898,
    path: "M 490 210 L 510 205 L 520 215 L 515 225 L 500 230 L 490 220 Z",
  },
  {
    id: "british",
    name: "British Empire",
    ...
    startYear: 1583,
    endYear: 1997,
    path: "M 490 180 L 505 175 L 510 185 L 505 195 L 495 195 L 490 190 Z",
  },
  {
    id: "mughal",
    name: "Mughal Empire",
    ...
    startYear: 1526,
    endYear: 1857,
    path: "M 650 220 L 670 215 L 680 225 L 675 245 L 660 250 L 650 240 Z",
  },
  {
    id: "qing",
    name: "Qing Dynasty",
    ...
    startYear: 1644,
    endYear: 1912,
    path: "M 710 160 L 740 150 L 760 160 L 755 190 L 730 200 L 710 190 Z",
  },
];
...
const TRADE_ROUTES: TradeRoute[] = [
  {
    id: "silk-road",
    name: "Silk Road",
    path: "M 740 190 Q 700 200 660 210 Q 620 220 580 225 Q 550 230 540 215",
    startYear: -130,
    endYear: 1453,
    color: "#F1C40F",
  },
  {
    id: "spice-route",
    name: "Spice Route",
    path: "M 670 240 Q 640 260 600 270 Q 560 280 540 260 Q 520 240 510 220",
    startYear: -300,
    endYear: 1800,
    color: "#E67E22",
  },
  {
    id: "trans-saharan",
    name: "Trans-Saharan",
    path: "M 500 280 Q 510 300 520 320 Q 530 340 540 360",
    startYear: -500,
    endYear: 1600,
    color: "#D4A017",
  },
  {
    ...
    path: "M 510 220 Q 480 250 460 290 Q 440 330 430 370 Q 420 410 440 440",
    startYear: 1400,
    endYear: 1800,
    color: "#3498DB",
  },
...
const MIGRATIONS: Migration[] = [
  {
    id: "indo-european",
    name: "Indo-European",
    path: "M 590 200 Q 620 190 650 200 Q 680 210 700 220",
    startYear: -4000,
    endYear: -1000,
  },
  {
    ...
    path: "M 530 320 Q 540 340 550 360 Q 560 380 570 400",
    startYear: -3000,
    endYear: 500,
  },
  {
    id: "polynesian",
    name: "Polynesian",
    path: "M 800 350 Q 830 360 860 370 Q 890 380 920 390",
    startYear: -1500,
    endYear: 1200,
  },
  {
    ...
    path: "M 510 160 Q 500 170 490 180 Q 480 190 470 200",
    startYear: 793,
    endYear: 1066,
  },
  {
    ...
    path: "M 700 170 Q 680 180 660 190 Q 640 200 620 210",
    startYear: 1206,
    endYear: 1368,
  },
];
    ...
    <div className="historical-map-container">
      ...
      <div className="hm-map-wrap">
        ...
        >
          ...
          {layers.migrations &&
            visibleMigrations.map((m) => (
              ...
              >
                <title>
                  {m.name} ({formatYear(m.startYear)} - {formatYear(m.endYear)})
                </title>
              </path>
            ))}
          ...
          {layers.civilizations &&
            visibleCivilizations.map((civ) => (
              ...
              >
                <title>
                  {civ.name} ({formatYear(civ.startYear)} - {formatYear(civ.endYear)})
                </title>
              </path>
            ))}
          ...
          {layers.tradeRoutes &&
            visibleTradeRoutes.map((route) => (
              ...
              >
                <title>
                  {route.name} ({formatYear(route.startYear)} - {formatYear(route.endYear)})
                </title>
              </path>
            ))}
        ...
        <div className="hm-zoom-controls">
          ...
          <button className="hm-zoom-btn" onClick={resetView} title="Reset" type="button">
            ⟲
          </button>
        </div>
        ...
        {selectedCity && (
          <div className="hm-info-panel">
            <button className="hm-info-close" onClick={() => setSelectedCity(null)} type="button">
              ✕
            </button>
            <h3>{selectedCity.name}</h3>
            <p>
              {selectedCity.civilization} · {formatYear(selectedCity.startYear)} –{" "}
              {formatYear(selectedCity.endYear)}
            </p>
          </div>
        )}
        ...
        <div className="hm-legend">
          <div className="hm-legend-item">
            <span className="hm-legend-dot" style={{ background: "#c8a951" }} />
            城市
          </div>
          <div className="hm-legend-item">
            <span className="hm-legend-dot" style={{ background: "#E74C3C" }} />
            战役
          </div>
          <div className="hm-legend-item">
            <span className="hm-legend-line" style={{ background: "#F1C40F" }} />
            贸易路线
          </div>
          <div className="hm-legend-item">
            <span className="hm-legend-line" style={{ background: "rgba(100,200,255,0.6)" }} />
            迁徙
          </div>
        </div>
      </div>
