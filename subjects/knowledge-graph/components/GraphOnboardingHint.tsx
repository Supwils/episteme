...
export function GraphOnboardingHint() {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex items-center gap-2.5 rounded-lg border border-white/10 bg-[#111118]/90 py-2 pr-1.5 pl-3.5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-md">
