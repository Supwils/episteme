...
import {
  PRODUCT_EASE,
  DOMAIN_META,
  DOMAIN_ACCENT_GRADIENT,
} from "./detail-panel/constants";
          ...
          <motion.aside
            ...
            className={clsx(
              ...
              isMobile
                ...
                : "inset-0 md:inset-auto md:top-0 md:right-0 md:h-full md:max-w-[420px] md:border-l",
          ...
          >
            ...
            <div className="flex items-center justify-end px-5 pt-4 pb-2 md:px-6">
              <button
                ...
                onClick={onClose}
                aria-label="关闭详情面板"
                className="flex h-11 w-11 md:h-8 md:w-8 items-center justify-center rounded-lg border border-white/[0.08] bg-white/[0.04] text-white/50 transition-colors duration-200 hover:border-white/[0.15] hover:bg-white/[0.08] hover:text-white/80"
              >
                <svg
                  viewBox="0 0 16 16"
                  fill="none"
