...
const QUOTES: Quote[] = [
  {
    ...
    source: "《论语·卫灵公》",
    context:
      "孔子回答弟子子贡'有一言而可以终身行之者乎'时所说。这条'恕道'成为儒家伦理的金规则，比西方的黄金律早数百年。",
  ...
  },
  {
    ...
    source: "《道德经》第一章",
    context:
      "《道德经》开篇之语，揭示了道家对语言局限性的根本认识——真正的'道'超越语言所能描述的范畴。",
  ...
  },
  {
    ...
    source: "四圣谛",
    context:
      "佛陀在鹿野苑初转法轮时宣说的四圣谛之第一谛——苦谛。这不是悲观主义，而是对存在本质的冷静诊断。",
  ...
  },
  {
    ...
    source: "柏拉图《申辩篇》38a",
    context:
      "苏格拉底在雅典法庭受审时的最后陈词。他宁愿赴死也不愿放弃哲学追问，这句话成为西方理性主义精神的基石。",
  ...
  },
  {
    ...
    source: "《泰阿泰德篇》155d",
    context:
      "柏拉图借苏格拉底之口说出。惊奇（thaumazein）不是恐惧，而是面对存在之谜时的敬畏——这是一切哲学探索的起点。",
  ...
  },
  {
    ...
    source: "《政治学》1253a",
    context:
      "亚里士多德认为人天生需要在城邦中生活才能实现自身的完善。孤立的个体要么是野兽，要么是神。",
  ...
  },
  {
    ...
    source: "《孟子·公孙丑上》",
    context:
      "孟子以'今人乍见孺子将入于井'的思想实验论证人性本善，开创了中国哲学史上最重要的人性论辩。",
  ...
  },
  {
    ...
    source: "《方法论》第四章",
    context:
      "笛卡尔通过系统怀疑找到了不可怀疑的基点——思维本身的存在。这一命题成为近代哲学的出发点。",
  ...
  },
  {
    ...
    source: "《伦理学》",
    context:
      "斯宾诺莎的泛神论将上帝等同于自然整体，打破了人格化上帝的传统观念，影响了后来的德国浪漫主义和爱因斯坦。",
  ...
  },
  {
    ...
    source: "《实践理性批判》结论",
    context:
      "康德将这段话刻在自己的墓碑上。外在宇宙的浩瀚与内在道德的崇高，在这位哥尼斯堡哲人身上达到了统一。",
  ...
  },
  {
    ...
    source: "《法哲学原理》序言",
    context:
      "黑格尔认为哲学总是来得太迟——它只能理解已经发生的事情，不能指导未来。这是对哲学功能的深刻反思。",
  ...
  },
  {
    ...
    source: "《焦虑的概念》",
    context:
      "克尔凯郭尔将焦虑与自由选择联系起来，开创了存在主义的先声。面对无限可能性时的眩晕感，正是人作为自由存在的证明。",
  ...
  },
  {
    ...
    source: "《快乐的科学》第125节",
    context:
      "尼采借'疯子'之口宣告的不是无神论的胜利，而是对西方文明价值根基崩塌的诊断——虚无主义时代的来临。",
  ...
  },
  {
    ...
    context:
      "胡塞尔创立现象学方法，要求搁置一切预设，直接面对意识中显现的现象。这一方法论革命影响了海德格尔、萨特、梅洛-庞蒂。",
  ...
  },
  {
    ...
    source: "《逻辑哲学论》7",
    context:
      "《逻辑哲学论》的最后一句话。维特根斯坦认为伦理、美学、宗教等领域超越了有意义的语言的界限。",
  ...
  },
  {
    ...
    source: "《存在与时间》",
    context:
      "海德格尔重新提出'存在问题'（Seinsfrage），区分存在（Sein）与存在者（Seiendes），要求重新思考被西方形而上学遗忘的根基。",
  ...
  },
  {
    ...
    source: "《存在与虚无》",
    context:
      "萨特在《存在主义是一种人道主义》演讲中将此命题通俗化：人没有预设的本质，他首先存在，然后通过自由选择来定义自己。",
  ...
  },
  {
    ...
    source: "《第二性》",
    context:
      "波伏娃用存在主义框架分析女性处境，论证性别是社会建构而非生物宿命。这本书成为第二波女权运动的思想基石。",
  ...
  },
  {
    ...
    source: "《性史》第一卷",
    context:
      "福柯将权力理解为弥散的、生产性的关系网络，而非自上而下的压迫。权力无处不在，抵抗也因此无处不在。",
  ...
  },
  {
    ...
    source: "《论文字学》",
    context:
      "德里达的解构主义挑战了西方哲学的'逻各斯中心主义'，认为意义永远处于延异（différance）之中，无法被最终固定。",
  ...
  },
  {
    ...
    source: "《传习录》",
    context:
      "王阳明心学的核心命题，主张真知必能行，不行只是未知。这一思想对日本明治维新产生了深远影响。",
    relatedIdeas: ["心即理", "致良知", "心学"],
  },
];

// Entries were appended as they were written (Marx 1845 before Kierkegaard 1844,
// Wang Yangming at the end); a timeline must read in date order.
export const CHRONOLOGICAL_QUOTES: readonly Quote[] = [...QUOTES].sort((a, b) => a.year - b.year);
      ...
      >
        <div className="flex items-center justify-between">
          <span
            ...
            style={{ color: `color-mix(in oklab, ${eraColor} 42%, var(--color-fg-primary))` }}
          >
            {quote.era}
          </span>
          <span className="text-fg-muted font-mono text-[10px] tracking-[0.18em]">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-fg-muted font-mono text-[9px] tracking-[0.14em]">
          ...
          <span
            className={`inline-block px-2 py-0.5 font-mono text-[8px] tracking-[0.2em] uppercase ${
              quote.tradition === "eastern"
                ? "border-accent-gold/40 text-fg-secondary border"
                : "border-accent-sage/40 text-fg-secondary border"
            }`}
          >
            {quote.tradition === "eastern" ? "东方" : "西方"}
          </span>
          <span className="text-fg-muted font-mono text-[8px] tracking-[0.14em]">
            {quote.source}
          </span>
        </div>

        {isActive && (
          <span className="text-fg-muted font-mono text-[8px] tracking-[0.2em]">↓ 点击收起</span>
        )}
        {!isActive && (
          <span className="text-fg-muted group-hover:text-fg-secondary font-mono text-[8px] tracking-[0.2em] transition-colors">
            点击展开 →
          </span>
        )}
      ...
      <div className="border-border-subtle bg-bg-elevated mx-auto max-w-2xl border p-6 md:p-8">
        <div className="mb-4 flex items-start justify-between">
          <div className="flex items-center gap-3">
            <span className="h-2 w-2" style={{ backgroundColor: eraColor }} aria-hidden />
            <span
              className="font-mono text-[10px] tracking-[0.28em] uppercase"
              style={{ color: `color-mix(in oklab, ${eraColor} 42%, var(--color-fg-primary))` }}
            >
              ...
              {quote.relatedIdeas.map((idea) => (
                <span
                  ...
                  style={{
                    ...
                    color: `color-mix(in oklab, ${eraColor} 42%, var(--color-fg-primary))`,
                  }}
                >
                  {idea}
                </span>
...
export default function QuotesTimeline() {
  ...
  const filtered =
    tradition === "all"
      ? CHRONOLOGICAL_QUOTES
      : CHRONOLOGICAL_QUOTES.filter((q) => q.tradition === tradition);
  ...
  return (
    <section className="landing-block relative w-full" aria-labelledby="quotes-timeline-title">
      <div>
        <div className="mb-8">
          <div className="mb-6 flex items-end gap-4">
            <h2 id="quotes-timeline-title" className="landing-block__title">
              哲学名言时间线
            </h2>
            ...
            <span className="text-fg-muted mb-0.5 hidden font-mono text-[10px] tracking-[0.2em] md:block">
              {filtered.length} quotes · {formatTimelineYear(timelineStart)} —{" "}
              {formatTimelineYear(timelineEnd)}
            </span>
          </div>
        ...
        <div className="mb-4">
          <div className="relative h-8 w-full overflow-hidden">
            <div className="absolute inset-0 flex items-center">
              <div className="via-border-subtle h-px w-full bg-gradient-to-r from-transparent to-transparent" />
            </div>
            {centuryMarks.map((y) => {
              ...
              return (
                <div
                  ...
                  style={{ left: `${pct}%` }}
                >
                  <span className="text-fg-muted font-mono text-[8px] tracking-[0.1em]">
