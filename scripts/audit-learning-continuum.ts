...
if (
  emptyFrontierView.recommendations.length !== coverage.summary.establishedDomainCount ||
  new Set(emptyFrontierView.recommendations.map((result) => result.domainId)).size !==
    coverage.summary.establishedDomainCount ||
